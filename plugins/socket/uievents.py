...
class UiEvents(object):
    def __init__(self, socketio, state, event_manager, logger):
        self.logger = logger
            ...
            if "bot" in state:
                ...
                if pokemon is not None:
                    ...
                    if response['evolution'].success:
                        ...
                        self.log('Evolved {} into {}'.format(bot.pokemon_list[pokemon.pokemon_id - 1]['Name'],
                                                             bot.pokemon_list[evolved_id - 1]['Name']), color="green")

                        event_manager.fire_with_context('pokemon_evolved', bot, pokemon=pokemon, evolution=evolved_id)
